<style>
  ...
  input { width: 100%; padding: 4px; border: 1px solid #c9c9c9; }
  input:focus { border: 1px solid #6284e2; }
  .message { color: rgb(167, 108, 0); }
...
<div class="container">
  <main class="form-reset">
    ...
    {#if !loading && !submitted}
      ...
      <div class="spacer">
        <input type="password" placeholder="New Password" bind:this={pass1} on:keyup={onPasswordChanged}>
      </div>
      <div class="spacer">
        <input type="password" placeholder="Confirm Password" bind:this={pass2} on:keyup={onPasswordChanged}>
      </div>
